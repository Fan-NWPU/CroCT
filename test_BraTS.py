...
parser.add_argument('--root_path', type=str,
                    default='/data/dataset/BraTS_2020/Test', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='BraTS/E-Net', help='experiment_name')
parser.add_argument('--model', type=str,
                    default='E-Net', help='model_name')
parser.add_argument('--num_classes', type=int,  default=1,
                    help='output channel of network')
parser.add_argument('--labeled_num', type=int, default=74,
                    help='labeled data')
...
def Inference(FLAGS):
    ...
    image_list = sorted([item.replace('\n', '').split(".")[0]
     ...
     snapshot_path = "../BraTS2020/{}_{}".format(
         FLAGS.exp, FLAGS.labeled_num)

    test_save_path = "../BraTS2020/{}_{}/prediction".format(
         FLAGS.exp, FLAGS.labeled_num)
